...
public class HistoricoConsultasController {
	...
	public static ModelAndView listar(Request req, Response res) {
		...
		// TODO no aparece el nombre en la lista :(
	 ...
	 * String terminal= req.queryParams("terminal");
	 * 
	 * List<DatosDeBusqueda> datosDeBusqueda =
	 * DatosBusquedaRepositoryMongoDB.instancia.obtenerPorNombre(terminal);
	 * 
	 * model.put("datosDebusqueda", datosDeBusqueda);
	 * 
	 * return new ModelAndView(model,
	 * "historicoConsultas/listarPorTerminal.hbs");
	 * 
	 * }
	 * 
	 ...
	 * 
	 * List<DatosDeBusqueda> datosDeBusqueda =
	 * DatosBusquedaRepositoryMongoDB.instancia.cantidadDePois(cantidad);
	 * 
	 * model.put("datosDebusqueda", datosDeBusqueda);
	 * 
	 * return new ModelAndView(model,
	 * "historicoConsultas/listarPorCantidad.hbs");
	 * 
	 * }
	 * 
	 ...
	 * 
	 * List<DatosDeBusqueda> datosDeBusqueda =
	 * DatosBusquedaRepositoryMongoDB.instancia.(fecha);
	 * 
	 * model.put("datosDebusqueda", datosDeBusqueda);
	 * 
